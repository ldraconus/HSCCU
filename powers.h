...
protected:
    ...
    static constexpr auto         Crtr = "crtr";
    static constexpr auto       Damage = "damage";
    static constexpr auto          Dcv = "dcv";
    static constexpr auto         Decr = "decr";
    static constexpr auto          Dbl = "dbl";
    ...
    static constexpr auto       Extend = "extend";
    static constexpr auto       Expand = "expand";
    static constexpr auto        Extra = "extra";
    static constexpr auto     Feedback = "feedback";
    static constexpr auto         Feed = "feed";
    static constexpr auto        Fewer = "fewer";
    ...
    static constexpr auto        Immun = "immun";
    ...
    static constexpr auto         Knck = "knck";
    ...
    static constexpr auto         Long = "long";
    ...
    static constexpr auto         Must = "must";
    ...
    static constexpr auto          Ocv = "ocv";
    static constexpr auto         Omcv = "omcv";
    ...
    static constexpr auto         Sehp = "sehp";
    static constexpr auto         Sehr = "sehr";
    static constexpr auto         Seic = "seic";
    static constexpr auto         Seih = "seih";
    static constexpr auto         Self = "self";
    static constexpr auto        Selpv = "selpv";
    ...
    static constexpr auto        Sleep = "sleep";
    ...
    static constexpr auto       Strong = "strong";
    ...
    static constexpr auto        Tasks = "tasks";
    ...
    static constexpr auto        ToEnd = "end";
    ...
    static constexpr auto         Weak = "weak";
